...
export const priceRanges = [
    ...
    { label: "₹ 2000 - ₹ 4000", count: 866 },
    { label: "₹ 4000 - ₹ 8000", count: 427 },
    { label: "₹ 8000 - ₹ 12000", count: 174 },
    { label: "₹ 12000 - ₹ 15000", count: 68 },
    { label: "₹ 15000 - ₹ 30000", count: 161 },
    { label: "₹ 30000+", count: 80 },
];

export const starRatings = [5, 4, 3];
